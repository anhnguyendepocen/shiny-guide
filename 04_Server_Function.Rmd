...
2. In the server function, build your output (e.g. plot, table, text, etc.) using one of the `render` functions (i.e. `renderPlot`, `renderDataTable`, `renderText`, etc.), choosing the function that matches your output type. 
