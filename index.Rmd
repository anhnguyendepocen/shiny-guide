...
Shiny needs to know which section of your script is the UI vs. which section is the server, so make sure to save your UI code to the `ui` object. At the bottom of your script, you will need to pass both the ui and server sections to the function `shiny::shinyApp()`.
